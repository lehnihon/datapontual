			...
			<div class="row">
				...
				<div class="col-md-9">
					...
					<div class="menu-header clearfix">
						...
						<div class="menu-op"><a href="<?php echo home_url( '/' )."ligue-agora"; ?>"><img alt="logo" class="e-claro menu-img tel" src="<?php echo dirname( get_bloginfo('stylesheet_url'))."/images/tel.png"; ?>" />Ligue Agora</a></div>	
						<div class="menu-op"><a href="<?php echo home_url( '/' )."envie-email"; ?>"><img alt="logo" class="e-claro menu-img email" src="<?php echo dirname( get_bloginfo('stylesheet_url'))."/images/e-mail.png"; ?>" />Envie um e-mail</a></div>								
